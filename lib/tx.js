...
async function createKeyregTransaction(options) {
	...
	options.vote_key = validateBuffer(options.vote_key, true, 'Invalid vote key.');
	options.selection_key = validateBuffer(options.selection_key, true, 'Invalid selection key.');
